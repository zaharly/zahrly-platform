...
export default function App() {
  return <AdminAuthGate><StoreProvider><AppShell><Routes>
    <Route path="/" element={<Dashboard/>}/><Route path="/incidents" element={<IncidentCenter/>}/><Route path="/bootstrap" element={<HistoricalBootstrap/>}/><Route path="/bootstrap/campaigns" element={<Navigate to="/bootstrap" replace/>}/>
    ...
    <Route path="/security/admins" element={<SecurityPage/>}/><Route path="/security/roles" element={<SecurityPage/>}/><Route path="/security/secrets" element={<SecurityPage/>}/><Route path="/security/rate-limits" element={<SecurityPage/>}/><Route path="/security/audit" element={<AuditLog/>}/><Route path="/security/jurisdiction" element={<Jurisdiction/>}/><Route path="/security/responsible-gambling" element={<Jurisdiction/>}/>
