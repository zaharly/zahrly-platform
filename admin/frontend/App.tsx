...
export default function App() {
  return <AdminAuthGate><StoreProvider><AppShell><Routes>
    ...
    <Route path="/security/admins" element={<SecurityPage/>}/><Route path="/security/roles" element={<SecurityPage/>}/><Route path="/security/secrets" element={<SecurityPage/>}/><Route path="/security/audit" element={<AuditLog/>}/><Route path="/security/rate-limits" element={<SecurityPage/>}/><Route path="/security/jurisdiction" element={<Jurisdiction/>}/><Route path="/security/responsible-gambling" element={<Jurisdiction/>}/>
