...
export default function App() {
  return <AdminAuthGate><StoreProvider><AppShell><Routes>
    ...
    <Route path="/data/countries" element={<Countries/>}/><Route path="/data/leagues" element={<Leagues/>}/><Route path="/data/leagues/:id" element={<LeagueDetail/>}/><Route path="/data/fixtures" element={<Fixtures/>}/><Route path="/data/quality" element={<DataQuality/>}/><Route path="/data/provider-incidents" element={<ProviderIncidents/>}/><Route path="/data/archive" element={<ArchivePage/>}/>
