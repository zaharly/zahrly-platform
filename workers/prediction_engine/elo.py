...
def update_elo(
    ...
    return (
        EloState(home.rating + delta, home.rating_deviation, home.volatility),
        EloState(away.rating - delta, away.rating_deviation, away.volatility),
        exp_home,
    )
